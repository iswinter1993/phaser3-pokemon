...
export const BATTLLE_ASSET_KEYS = Object.freeze({
    ...
    DAMAGED_BALL:'DAMAGED_BALL'//抓怪兽-初级球
})
...
export const WORLD_ASSET_KEYS = Object.freeze({
    ...
    MAIN_1_LEVEL:'MAIN_1_LEVEL',//所有main层json数据
    MAIN_1_FOREGROUND:'MAIN_1_FOREGROUND',//碰撞块上方的图片
...
export const BUILDING_ASSET_KEYS = Object.freeze({
    ...
    BUILDING_1_LEVEL:'BUILDING_1_LEVEL',//所有main层json数据
    BUILDING_1_FOREGROUND:'BUILDING_1_FOREGROUND',//碰撞块上方的图片
    BUILDING_2_BACKGROUND:'BUILDING_2_BACKGROUND',
    BUILDING_2_LEVEL:'BUILDING_2_LEVEL',//所有main层json数据
    BUILDING_2_FOREGROUND:'BUILDING_2_FOREGROUND',//碰撞块上方的图片
})
